module EstimatesHelper
  ...
  def _new_estimate_entry_path(project, issue, *args)
    if issue
      new_issue_estimate_entry_path(issue, *args)
    elsif project 
      new_project_estimate_entry_path(project, *args)
    else
      new_estimate_entry_path(*args)
    end
  end
